        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 md:space-y-10 animate-fade-in text-center lg:text-left">
                ...
                <div className="space-y-6">
                    ...
                    <h2 className="text-xl md:text-3xl lg:text-4xl font-display font-bold text-white/90 max-w-xl mx-auto lg:mx-0 leading-tight">
                        Solving <span className="wine-gradient italic">Complex Workflows</span> Through Intelligent Automation.
                    </h2>
                </div>

                <p className="text-base md:text-lg lg:text-xl text-text-dim leading-[1.8] max-w-2xl mx-auto lg:mx-0 font-light">
